...
trait AttachmentsConnector {
  ...
  def createEnvelope()(implicit hc: HeaderCarrier): Future[HttpResponse] = {
    http.POSTEmpty[HttpResponse](s"$serviceUrl/investment-tax-relief-attachments/file-upload/create-envelope")
  }
  ...
  def closeEnvelope(envelopeId: String)(implicit hc: HeaderCarrier): Future[HttpResponse] = {
    http.POSTEmpty[HttpResponse](s"$serviceUrl/investment-tax-relief-attachments/file-upload/envelope/$envelopeId/close-envelope")
  }

  def deleteFile(envelopeId: String, fileID: String)(implicit hc: HeaderCarrier): Future[HttpResponse] = {
    http.DELETE[HttpResponse](s"$serviceUrl/investment-tax-relief-attachments/file-upload/envelope/$envelopeId/file/$fileID/delete-file")
  }
